...
const DarkmodeToggle = () => {
  ...
  return (
    <label
      className='cursor-pointer relative h-[calc(var(--drkModeToggleSize)/3)] w-[calc(var(--drkModeToggleSize)/1.15)]'
    ...
    >
      ...
      {/* Lightmode sun */}
      <div className='peer-checked:opacity-0 peer-checked:translate-x-12 peer-checked:translate-y-8 peer-checked:-rotate-0 absolute opacity-100 translate-x-[calc(var(--drkModeToggleSize)/14)] translate-y-[calc(var(--drkModeToggleSize)/22)] rotate-12 origin-[50%_50%] transition-all duration-300'>
        <svg
          ...
          viewBox='0 0 24 24'
          className='absolute h-[calc(var(--drkModeToggleSize)/4.5)] w-[calc(var(--drkModeToggleSize)/4.5)] text-orange-400'
      ...
      {/* Lightmode moon */}
      <div className='peer-checked:bg-[#485367] peer-checked:shadow-white peer-checked:translate-x-[calc(var(--drkModeToggleSize)/20)] absolute h-[calc(var(--drkModeToggleSize)/4.5)] w-[calc(var(--drkModeToggleSize)/4.5)] rounded-full bg-yellow-200 translate-x-[calc(var(--drkModeToggleSize)/1.8)] translate-y-[calc(var(--drkModeToggleSize)/20)] shadow-[inset_0_0_0_0.1em] shadow-orange-400 transition-all duration-300'></div>
